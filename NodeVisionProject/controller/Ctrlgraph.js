var Ctrlgraph = (function () {
    function Ctrlgraph() {
    }
    Ctrlgraph.prototype.updateView = function (uigraph) {
        this.uigraph = uigraph;
        this.uigraph.setui(this.graph);
    };
    Ctrlgraph.prototype.updateModel = function (req) {
        switch (req.crud) {
            case Action.create:
            ...
            case Action.read:
                ...
                ///////////////////////////////////////////////////
                return new response(Status.sucess, 'TEST', this.graph);
                break;
            case Action.update:
                //TODO socket emit -> callback
                ///////////////////////TEST///////////////////////
                ...
                return new response(Status.sucess, 'TEST', this.graph, this.uigraph);
                break;
            case Action.delete:
                //TODO socket emit -> callback
                ///////////////////////TEST///////////////////////
...
//# sourceMappingURL=Ctrlgraph.js.map